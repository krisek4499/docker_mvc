    ...
    <div class="TRESC">
      <div class="navbar-nav">
        <div class="list-group">
           <a href="/Index/show_all" class="list-group-item list-group-item-action active ">Wyświetl użytkowników</a>
 
           <a href="/Index/news" class="list-group-item list-group-item-action ">Formularz</a>
          </div>
        </div>
      </div>
    </div>
